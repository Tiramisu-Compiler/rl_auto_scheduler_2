...
# from core.models.tiramisu_program import TiramisuProgram
# from utils.config.config import Config

# class CompilingService():
#     @classmethod
#     def compile_legality(cls,tiramisu_program : TiramisuProgram, optims_list : list ,comps=None,first_comp=None,):
