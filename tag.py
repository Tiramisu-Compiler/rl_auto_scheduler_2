...
if __name__ == "__main__":
    ...
    comps_expr_tensor,
    comps_expr_lengths) = ConvertService.get_representation_template(tiramisu_api.scheduler_service.schedule_object.prog.annotations,
                                tiramisu_api.scheduler_service.schedule_object.schedule_dict_tags,5)
    comps_tensor, loops_tensor = ConvertService.get_schedule_representation(
