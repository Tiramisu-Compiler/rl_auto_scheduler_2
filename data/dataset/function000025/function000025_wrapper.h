...
extern "C" {
#endif
int function000025(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", "7.5542449951171875", true); // This value was set by the Code Generator
}
