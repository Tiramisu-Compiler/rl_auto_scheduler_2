#include "Halide.h"
#include "function000030_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(1280* sizeof(double));
	parallel_init_buffer(c_buf00, 1280, (double)60);
	Halide::Buffer<double> buf00(c_buf00, 1280);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000030(buf00.raw_buffer());
