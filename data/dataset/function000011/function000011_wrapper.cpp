#include "Halide.h"
#include "function000011_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(322* sizeof(double));
	parallel_init_buffer(c_buf00, 322, (double)83);
	Halide::Buffer<double> buf00(c_buf00, 322);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000011(buf00.raw_buffer());
