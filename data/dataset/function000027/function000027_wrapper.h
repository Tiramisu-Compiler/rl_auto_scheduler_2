...
extern "C" {
#endif
int function000027(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", "0.507843017578125", true); // This value was set by the Code Generator
}
