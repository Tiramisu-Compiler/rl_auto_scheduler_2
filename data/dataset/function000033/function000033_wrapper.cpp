#include "Halide.h"
#include "function000033_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(513*256* sizeof(double));
	parallel_init_buffer(c_buf00, 513*256, (double)56);
	Halide::Buffer<double> buf00(c_buf00, 513,256);

	double *c_buf01 = (double*)malloc(2050*514* sizeof(double));
	parallel_init_buffer(c_buf01, 2050*514, (double)87);
	Halide::Buffer<double> buf01(c_buf01, 2050,514);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000033(buf00.raw_buffer(),buf01.raw_buffer());
