#include "Halide.h"
#include "function000012_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(128*64*130* sizeof(double));
	parallel_init_buffer(c_buf00, 128*64*130, (double)10);
	Halide::Buffer<double> buf00(c_buf00, 128,64,130);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000012(buf00.raw_buffer());
