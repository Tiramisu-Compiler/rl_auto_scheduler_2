#include "Halide.h"
#include "function000032_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(32* sizeof(double));
	parallel_init_buffer(c_buf00, 32, (double)38);
	Halide::Buffer<double> buf00(c_buf00, 32);

	double *c_buf01 = (double*)malloc(32*32* sizeof(double));
	parallel_init_buffer(c_buf01, 32*32, (double)1);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000032(buf00.raw_buffer(),buf01.raw_buffer());
