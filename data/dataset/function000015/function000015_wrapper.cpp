#include "Halide.h"
#include "function000015_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(192* sizeof(double));
	parallel_init_buffer(c_buf00, 192, (double)26);
	Halide::Buffer<double> buf00(c_buf00, 192);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000015(buf00.raw_buffer());
