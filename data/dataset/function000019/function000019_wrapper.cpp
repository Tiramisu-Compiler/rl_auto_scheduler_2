#include "Halide.h"
#include "function000019_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(1026* sizeof(double));
	parallel_init_buffer(c_buf00, 1026, (double)16);
	Halide::Buffer<double> buf00(c_buf00, 1026);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000019(buf00.raw_buffer());
