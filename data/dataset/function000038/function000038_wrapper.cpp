#include "Halide.h"
#include "function000038_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(1024*1024* sizeof(double));
	parallel_init_buffer(c_buf00, 1024*1024, (double)26);
	Halide::Buffer<double> buf00(c_buf00, 1024,1024);

	double *c_buf01 = (double*)malloc(128* sizeof(double));
	parallel_init_buffer(c_buf01, 128, (double)57);
	Halide::Buffer<double> buf01(c_buf01, 128);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000038(buf00.raw_buffer(),buf01.raw_buffer());
