...
extern "C" {
#endif
int function000024(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", "9.005859375", true); // This value was set by the Code Generator
}
