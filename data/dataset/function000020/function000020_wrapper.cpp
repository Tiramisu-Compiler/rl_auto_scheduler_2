#include "Halide.h"
#include "function000020_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(256*1024* sizeof(double));
	parallel_init_buffer(c_buf00, 256*1024, (double)2);
	Halide::Buffer<double> buf00(c_buf00, 256,1024);
	double *c_buf01 = (double*)malloc(258*256*256* sizeof(double));
	parallel_init_buffer(c_buf01, 258*256*256, (double)11);
	Halide::Buffer<double> buf01(c_buf01, 258,256,256);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000020(buf00.raw_buffer(),buf01.raw_buffer());
