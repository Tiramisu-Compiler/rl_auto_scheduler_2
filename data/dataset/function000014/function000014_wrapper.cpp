#include "Halide.h"
#include "function000014_wrapper.h"
...
{
	Halide::Buffer<double> buf00(32,97);

	double *c_buf01 = (double*)malloc(98* sizeof(double));
	parallel_init_buffer(c_buf01, 98, (double)52);
	Halide::Buffer<double> buf01(c_buf01, 98);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000014(buf00.raw_buffer(),buf01.raw_buffer());
