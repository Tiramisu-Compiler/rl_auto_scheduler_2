#include "Halide.h"
#include "function000029_wrapper.h"
...
{
	Halide::Buffer<double> buf00(17,256);

	double *c_buf01 = (double*)malloc(18*256*768* sizeof(double));
	parallel_init_buffer(c_buf01, 18*256*768, (double)32);
	Halide::Buffer<double> buf01(c_buf01, 18,256,768);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000029(buf00.raw_buffer(),buf01.raw_buffer());
