#include "Halide.h"
#include "function000034_wrapper.h"
...
{
	double *c_buf00 = (double*)malloc(257*257* sizeof(double));
	parallel_init_buffer(c_buf00, 257*257, (double)97);
	Halide::Buffer<double> buf00(c_buf00, 257,257);

	double *c_buf01 = (double*)malloc(258*258*258* sizeof(double));
	parallel_init_buffer(c_buf01, 258*258*258, (double)4);
	Halide::Buffer<double> buf01(c_buf01, 258,258,258);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000034(buf00.raw_buffer(),buf01.raw_buffer());
