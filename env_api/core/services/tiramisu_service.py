...
class TiramisuService:
    ...
    def fetch_prog_offline(self, name: str, data: dict, original_str: str = None, wrappers: dict = None):
        # This function fetched all the data from an offline dataset
        tiramisu_prog = TiramisuProgram.from_dict(
            name=name, data=data, original_str=original_str, wrappers=wrappers)
        return tiramisu_prog
